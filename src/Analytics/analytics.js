...
export const registrarConversacion = (chatId, userMessage, botResponse) => {
    ...
    const conversacion = {
        ...
        escalated: userMessage.includes('urgente') || userMessage.includes('supervisor')
    };
...
function analizarSentimiento(mensaje) {
    ...
    const palabrasNegativas = ['problema', 'error', 'mal', 'terrible', 'horrible', 'molesto', 'frustrado'];
...
function analizarEmocion(mensaje) {
    ...
    if (mensajeLower.includes('urgente') || mensajeLower.includes('rápido')) return 'urgente';
    if (mensajeLower.includes('confundido') || mensajeLower.includes('no entiendo')) return 'confundido';
    if (mensajeLower.includes('molesto') || mensajeLower.includes('frustrado')) return 'frustrado';
    if (mensajeLower.includes('feliz') || mensajeLower.includes('contento')) return 'feliz';
